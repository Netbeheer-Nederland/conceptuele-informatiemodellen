...
generate-documentation: clean
    ...
    cp -r "documentation" "artifacts/documentation/conceptuele-informatiemodellen"

    # Append main nav with "Models" heading
    echo -e '** Modellen' >> "artifacts/documentation/conceptuele-informatiemodellen/_/modules/ROOT/partials/nav.adoc"
